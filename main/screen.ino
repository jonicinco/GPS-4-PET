...
//Reemplaza cualquier llamada directa a screen_print para mostrar datos GPS con llamada a displayMessage para pausa
void displayMessage(const char* message) {
    screen_clear();  // Limpiar la pantalla
    screen_print(message);  // Mostrar el mensaje
    screen_update();  // Actualizar la pantalla
    delay(2000);  // Pausa de 2 segundos para leer
}